...
$tipenota =mysqli_real_escape_string($kon,@$_POST['Tipe_nota']);
$diskon =mysqli_real_escape_string($kon,@$_POST['Diskon']);

if ($id =="" || $nama =="" || $alamat =="" || $telepon =="" || $tipenota =="" || $diskon ==""  )
{
?>
...
if (perbaharui($_POST) > 0){
	...
	<script>
			...
			document.location.href = 'index.php?pages=setting&aksi=tampil';
	</script>
	";
	echo "<br>";
...
<meta http-equiv="refresh" content="1; url=index.php?pages=crud_inner&inner=tampil">
<?php
}
?>
