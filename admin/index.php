        ...
        <div class="navbar-vertical-content">
          <ul class="navbar-nav flex-column" id="navbarVerticalNav">
            <li class="nav-item">
              ...
              <div class="nav-item-wrapper"><a class="nav-link label-1" href="index.php?pages=menu&aksi=tampil" role="button" data-bs-toggle="" aria-expanded="false">
                  <div class="d-flex align-items-center"><span class="nav-link-icon"><span data-feather="trello"></span></span><span class="nav-link-text-wrapper"><span class="nav-link-text">Menu/Kategori</span></span></div>
                </a></div><!-- parent pages-->
              <div class="nav-item-wrapper"><a class="nav-link label-1" href="apps/chat.html" role="button" data-bs-toggle="" aria-expanded="false">
            ...
            <li class="nav-item">
              ...
              <div class="nav-item-wrapper"><a class="nav-link label-1" href="index.php?pages=setting&aksi=tampil" role="button" data-bs-toggle="" aria-expanded="false">
